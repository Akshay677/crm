...
CRM_ALLOWED_ROLES = ["System Manager", "Sales Manager", "Sales User", "Project Manager", "Editor", "Executor"]
...
def get_users(include_all: bool = False):
	...
	role_priority = ("System Manager", "Sales Manager", "Project Manager", "Editor", "Executor", "Sales User", "Guest")
	crm_users = []
