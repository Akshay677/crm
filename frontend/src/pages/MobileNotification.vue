...
<template>
  ...
  <div class="flex flex-col overflow-hidden text-ink-gray-9">
    <div
      ...
      class="overflow-y-auto text-base"
    >
      <div v-for="group in groupedNotifications" :key="group.title">
        <div class="sticky top-0 z-10 bg-surface-gray-2 px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-ink-gray-6 border-y border-outline-gray-1">
          {{ __(group.title) }}
        </div>
        <div class="divide-y divide-outline-gray-1">
          <RouterLink
            ...
            :to="getRoute(n)"
            class="flex cursor-pointer items-start gap-3 px-2.5 py-3 hover:bg-surface-gray-2 transition-colors"
